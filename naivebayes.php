...
<?php
#prior probability
$sql_jumlah_china = mysql_query("select count(id) as jumlah from data_training where kelas=1"); //query mencari jumlah tweet dalam kelas china
$sql_jumlah_japan = mysql_query("select count(id) as jumlah from data_training where kelas=2"); //query mencari jumlah tweet dalam kelas japan
$sql_jumlah_tweet = mysql_query("select count(id) as jumlah from data_training"); //query mencari jumlah tweet
...
$sql_china = "select id,tweet,kelas from data_training where kelas=1";
...
#kelas japan
$sql_japan = "select id,tweet,kelas from data_training where kelas=2";
...
$sql_vocab = "select id,tweet,kelas from data_training";
